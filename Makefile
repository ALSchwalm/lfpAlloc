...
profile.out: tests/profile.cpp
	$(CXX) -I. -std=c++11 -O3 -Wall -Wextra tests/profile.cpp -pthread -o profile.out

tests.out: $(TEST_OBJ)
	$(CXX) $(TEST_OBJ) -I. -lgtest -std=c++11 -o tests.out -lpthread -Wall -Wextra

tests/%.o: tests/%.cpp
	$(CXX) $(CC_FLAGS) -c -o $@ $< -I. -std=c++11 -Wall -Wextra
